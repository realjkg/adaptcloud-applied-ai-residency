export type AppEnvironment = "development" | "test" | "sandbox" | "qa" | "staging" | "production";
...
const environments = new Set<AppEnvironment>(["development", "test", "sandbox", "qa", "staging", "production"]);
